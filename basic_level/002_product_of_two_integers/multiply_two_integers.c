...
/*
 * Implement a function that calculates the product of two integers. The function should receive two integers as arguments, multiply them, and return the result.
 */
